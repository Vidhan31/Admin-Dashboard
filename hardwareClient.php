...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            <li>
                <a href="hardwareClient.php" class="active">
                    <i class='bx bx-tachometer' style="font-size: 25px;"></i>
                    <span class="links_name">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="hardwareProduct.php">
    ...
    <section class="home-section">
      ...
      <div class="overview-boxes">
        ...
        <div class="box">
          ...
          <i><img src="\project\images\totalcustomers.png" alt="customerpic"></i>
        </div>
        <div class="box">
          <div class="right-side">
        ...
        <div class="box">
          ...
          <i style="float: right;"><img src="\project\images\totalstock.png" alt="totalstockpic"></i>
        </div>
      </div>
